    ...
    <div className="relative flex flex-row items-start justify-start gap-2 text-sm">
      ...
      >
        <div
          ...
          className="flex h-5 w-5 cursor-pointer items-center justify-center rounded-md text-muted-foreground transition-colors ease-in-out hover:bg-accent hover:text-foreground"
        >
